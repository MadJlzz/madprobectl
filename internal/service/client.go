...
func Post(endpoint endpoints.Endpoint, yamlProbe parser.HttpProbe) error {
	// TODO: Handles now multiple probes in a single file but we do
	// TODO: 1 request per probe creation. Madprobe should take an array for probe creation.
	for _, probe := range yamlProbe.Http {
